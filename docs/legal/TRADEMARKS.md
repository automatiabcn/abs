...
## 2. Nominative Fair Use (Allowed Without Permission)  
...
|----------|-------------------|
| **White‑label or OEM resale** | Re‑branding the product as "Acme AI Orchestrator" and selling it under a different brand while retaining the underlying code. |
| **Hosted SaaS services** | Operating a multi‑tenant cloud service that uses the name "Automatia Cloud" or "ABS‑Analytics" as part of the service name. |
| **Derivative product names** | Creating a new product called "AcmeABS" or "ABS‑Pro" that incorporates the mark into its own brand. |
| **Logo or brand‑color usage** | Using the official Automatia logo, the specific shade of "Automatia blue" (#0055AA), or any other visual identity element in marketing collateral. |
| **Domain names** | Registering domains such as `automatiaabs.io`, `abs‑tools.com`, or any other URL that contains the marks and could be perceived as an official site. |
| **Merchandise** | Producing t‑shirts, stickers, or other physical goods that display the marks. |

Permission is granted at Automatia BCN's sole discretion and may be subject to additional licensing terms, quality‑control requirements, or royalty arrangements.

---  

## 4. Uses That Are Never Permitted  
...
5. **Distortion or degradation** – Displaying the marks at low resolution, in a stretched aspect ratio, or alongside offensive content.  

Violations may result in a cease‑and‑desist request, removal of infringing material, or legal action where appropriate.
...
* The Apache 2.0 conversion permits unrestricted use of the code, but it does **not** grant any right to use the marks in marketing, branding, or product naming.  

In short, the code license governs **what you may do with the software**, while this trademark policy governs **how you may refer to the software and the company**.
...
* Your contact name, organization (if any), and preferred method of reply.  

Automatia BCN aims to acknowledge receipt within **2 business days** and to provide a substantive response within **5 business days**. We may request additional information to verify the claim before taking corrective action.

---  

## 7. Updates  

The current, authoritative version of this policy is hosted at:  

`https://github.com/automatiabcn/abs/blob/main/docs/legal/TRADEMARKS.md`  

Automatia BCN may amend the policy from time to time. The "last updated" date at the top of the document reflects the most recent revision.
