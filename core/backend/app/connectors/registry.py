...
_LIST: List[Connector] = [
    ...
    _c(
        id="meta_ads", name="Meta Ads", group=GRP_COMMS, kind="read", note="attribution"
    ),
    _c(
        id="linkedin_ads",
        name="LinkedIn Ads",
