...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("action_kind", sa.String(32), nullable=False, server_default="internal"),
    ...
    op.create_index("ix_action_executions_tenant_slug", "action_executions", ["tenant_slug"])
    op.create_index("ix_action_executions_approval_item_id", "action_executions", ["approval_item_id"])
    ...
    op.create_index("ix_agentic_workflow_defs_tenant_slug", "agentic_workflow_defs", ["tenant_slug"])
    ...
    op.add_column("connector_states", sa.Column("auth_kind", sa.String(16), nullable=False, server_default="none"))
    op.add_column("connector_states", sa.Column("encrypted_credentials", sa.String(8192), nullable=False, server_default=""))
    op.add_column("connector_states", sa.Column("last_sync_count", sa.Integer, nullable=False, server_default="0"))
    op.add_column("connector_states", sa.Column("last_error", sa.String(512), nullable=True))
