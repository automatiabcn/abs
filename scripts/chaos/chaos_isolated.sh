...
#
# Usage:
#   bash scripts/chaos/chaos_isolated.sh up      # spin up chaos namespace
#   bash scripts/chaos/chaos_isolated.sh kill    # scenario 1
#   bash scripts/chaos/chaos_isolated.sh pause   # scenario 2
#   bash scripts/chaos/chaos_isolated.sh netcut  # scenario 3
#   bash scripts/chaos/chaos_isolated.sh diskfull # scenario 4
#   bash scripts/chaos/chaos_isolated.sh redis   # scenario 5
#   bash scripts/chaos/chaos_isolated.sh down    # tear down
